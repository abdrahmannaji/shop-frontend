...
class _ChatScreenState extends State<ChatScreen> {
  ...
  getMyInfoFromSharedPreference() async {
    ...
    // shopname = await SharedPreferenceHelper().getUserName();
    // myEmail = await SharedPreferenceHelper().getUserEmail();
    print(widget.chatWithUsername);
    chatRoomId = getChatRoomIdByUsernames(widget.chatWithUsername, shopname);
  }
